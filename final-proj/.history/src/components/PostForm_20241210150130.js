...
const PostForm = ({onSubmit, inititalValues = {title: '', content: ''}}) => {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      setContent(translatedContent); // Update content with translated text
      const languageName = languageMap[targetLang]; 
      onSubmit(title, translatedContent, languageName); // Pass the translated content and language onSubmit
    } catch (error) {
