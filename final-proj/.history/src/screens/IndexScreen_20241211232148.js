...
const IndexScreen = ({navigation}) => {
  ...
  useEffect(() => {
    ...
    const focusListener = navigation.addListener('focus', fetchPosts); 
  ...
  // Separated another useEffect to group posts whenever state updates.
  useEffect(() => {
...
const styles = StyleSheet.create({
  ...
  imgcontainer: {
    position: 'relative', // Makes the parent container the reference for absolute positioning
    flex: 1,
    backgroundColor: '#F6F5FA',
    padding: 20,
  },
